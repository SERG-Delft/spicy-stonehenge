    ...
    extends BaseTypeDefsBuilder
{
    ...
    private void addComplexTypes0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes) {
        ...
        // Type #9 (UpdateAccountProfileResponse)
        ...
        // Type #24 (AccountData)
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS2, "AccountData")));
        // Type #25 (BuyRequest)
    ...
    private void addComplexTypeElements0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes) {
        ...
        currType.addComplexElement(new QName(NS2, "account"), complexTypes.get(24), 1);
        ...
        currType.addSimpleElement(new QName(NS2, "profileID"), 1);
        currType.addSimpleElement(new QName(NS2, "openBalance"), 1);
        currType.addSimpleElement(new QName(NS2, "balance"), 1);
        currType.addSimpleElement(new QName(NS2, "creationDate"), 1);
        currType.addSimpleElement(new QName(NS2, "lastLogin"), 1);
        currType.addSimpleElement(new QName(NS2, "logoutCount"), 1);
        currType.addSimpleElement(new QName(NS2, "loginCount"), 1);
        currType.addSimpleElement(new QName(NS2, "accountID"), 1);
        ...
        currType.addSimpleElement(new QName(NS1, "timestamp"), 1);
        currType.addComplexElement(new QName(NS1, "extension"), complexTypes.get(42), -1);
        currType.addComplexElement(new QName(NS2, "accountData"), complexTypes.get(24), 1);
    ...
    private void addRootElements0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes, HashMap<QName, FlatSchemaElementDeclImpl> rootElements) {
        ...
        rootElements.put(new QName(NS2, "getHoldingsRequest"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "getHoldingsRequest"), complexTypes.get(32)));
        ...
        rootElements.put(new QName(NS2, "getAccountDataResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "getAccountDataResponse"), complexTypes.get(31)));
        rootElements.put(new QName(NS2, "getAllQuotesRequest"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "getAllQuotesRequest"), complexTypes.get(33)));
        ...
        rootElements.put(new QName(NS2, "getMarketSummaryResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "getMarketSummaryResponse"), complexTypes.get(34)));
        ...
        rootElements.put(new QName(NS2, "updateAccountProfileResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "updateAccountProfileResponse"), complexTypes.get(9)));
