 ...
 * 
 */
public class QuoteServiceV1TypeDefsBuilder
    extends BaseTypeDefsBuilder
{
    ...
    private void addComplexTypes0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes) {
        ...
        complexTypes.add(new FlatSchemaComplexTypeImpl(new QName(NS2, "GetQuotesRequest")));
        // Type #2 (BaseResponse)
    ...
    private void addRootElements0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes, HashMap<QName, FlatSchemaElementDeclImpl> rootElements) {
        rootElements.put(new QName(NS2, "getQuotesRequest"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "getQuotesRequest"), complexTypes.get(1)));
        rootElements.put(new QName(NS2, "getQuotesResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "getQuotesResponse"), complexTypes.get(3)));
    }
