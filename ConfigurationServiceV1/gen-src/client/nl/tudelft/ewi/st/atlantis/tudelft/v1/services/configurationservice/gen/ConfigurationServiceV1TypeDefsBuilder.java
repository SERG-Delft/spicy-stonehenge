    ...
    extends BaseTypeDefsBuilder
{
    ...
    private void addComplexTypeElements0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes) {
        ...
        currType.addComplexElement(new QName(NS1, "extension"), complexTypes.get(21), -1);
        ...
        currType.addComplexElement(new QName(NS1, "errorMessage"), complexTypes.get(23), 1);
        ...
        currType.addSimpleElement(new QName(NS1, "timestamp"), 1);
        currType.addComplexElement(new QName(NS1, "extension"), complexTypes.get(21), -1);
        currType.addComplexElement(new QName(NS2, "locations"), complexTypes.get(18), -1);
        ...
        currType.addComplexElement(new QName(NS1, "extension"), complexTypes.get(21), -1);
        currType.addComplexElement(new QName(NS2, "location"), complexTypes.get(18), 1);
        ...
        currType.addComplexElement(new QName(NS1, "parameter"), complexTypes.get(22), -1);
        ...
        currType.addComplexElement(new QName(NS1, "error"), complexTypes.get(20), -1);
    ...
    private void addRootElements0(ArrayList<FlatSchemaComplexTypeImpl> complexTypes, HashMap<QName, FlatSchemaElementDeclImpl> rootElements) {
        rootElements.put(new QName(NS2, "setBSToOPSResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "setBSToOPSResponse"), complexTypes.get(17)));
        rootElements.put(new QName(NS2, "getOPSLocationsResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "getOPSLocationsResponse"), complexTypes.get(27)));
        rootElements.put(new QName(NS2, "getESLocationsResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "getESLocationsResponse"), complexTypes.get(26)));
        rootElements.put(new QName(NS2, "getClientConfigResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "getClientConfigResponse"), complexTypes.get(15)));
        rootElements.put(new QName(NS2, "getOPSConfigResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "getOPSConfigResponse"), complexTypes.get(13)));
        rootElements.put(new QName(NS2, "getBSLocationsResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "getBSLocationsResponse"), complexTypes.get(10)));
        rootElements.put(new QName(NS2, "getClientConfigRequest"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "getClientConfigRequest"), complexTypes.get(12)));
        ...
        rootElements.put(new QName(NS2, "getOPSConfigRequest"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "getOPSConfigRequest"), complexTypes.get(9)));
        ...
        rootElements.put(new QName(NS2, "setClientToBSRequest"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "setClientToBSRequest"), complexTypes.get(7)));
        rootElements.put(new QName(NS2, "getESLocations"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "getESLocations"), complexTypes.get(25)));
        rootElements.put(new QName(NS2, "setBSToOPSRequest"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "setBSToOPSRequest"), complexTypes.get(16)));
        rootElements.put(new QName(NS2, "setServiceLocationResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "setServiceLocationResponse"), complexTypes.get(11)));
        ...
        rootElements.put(new QName(NS2, "getBSConfigResponse"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "getBSConfigResponse"), complexTypes.get(8)));
        ...
        rootElements.put(new QName(NS2, "setServiceLocationRequest"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "setServiceLocationRequest"), complexTypes.get(14)));
        rootElements.put(new QName(NS2, "getOPSLocations"), FlatSchemaElementDeclImpl.createRootComplexElement(new QName(NS2, "getOPSLocations"), complexTypes.get(24)));
    }
